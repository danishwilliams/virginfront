angular
  ...
  .config(function ($stateProvider, $urlRouterProvider, $locationProvider, APP_PERMISSIONS) {
  ...
  .run(['$rootScope', '$state', 'Users', 'Authorizer', function ($rootScope, $state, Users, Authorizer) {
