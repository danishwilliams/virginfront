/* Autogenerated file from language-export.js to prevent the Flash Of Untranslated Content on first page visit */angular.module('app').constant('defaultI18n', { en: {
  ...
  "CLASS_LENGTH_ERROR": "Try to get your ride closer to {{minutes}} minutes by reviewing your song choices.",
  ...
  "CHOOSE_TRACK": "Choose a song for",
  ...
  "NO_TRACKS": "No songs to show, try widening your search.",
  "All": "All",
  "Blues": "Blues",
  "Classical": "Classical",
  ...
  "DEVICE_NAME_EXPLANATION": "This name will be used to identify devices and will be displayed on the device login screen.",
  ...
  "CODE_ONCE": "Take a screenshot or write down this code to remember it.",
  "DEVICE_INTERNET": "When using this code to provision a device, ensure that the device is connected to the internet.",
